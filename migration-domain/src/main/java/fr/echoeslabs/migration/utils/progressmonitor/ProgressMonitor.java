...
public interface ProgressMonitor {
	 ...
	 * @throws Exception
	 */
	public <R> R executeTask(String task, Callable<R> _callable) throws Exception;

	/**
	 * Execute task with an amount of work and encapsulates the behaviour of the
	 * progress monitor.
	 *
	 * @param <R>
	 *            the generic type
	 ...
	 * @throws Exception
	 */
	public <R> R executeTask(String taskName, Callable<R> callable, int size) throws Exception;
